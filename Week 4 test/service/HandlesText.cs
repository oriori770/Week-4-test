...
namespace Week_4_test.service
{
    internal static class HandlesText
    {
        ...
        static Dictionary<string, string> Year = new Dictionary<string, string>()
        {
            ...
            {"תשפ\"ז", "חמשת אלפים ושבע מאות ושמנים ושבעה" },
            {"תשפ\"ח", "חמשת אלפים ושבע מאות ושמנים ושמנה" },
            {"תשפ\"ט", "חמשת אלפים ושבע מאות ושמנים ותשעה" },
            {"תש\"צ", "חמשת אלפים ושבע מאות ותשעים" },
            {"תשצ\"א", "חמשת אלפים ושבע מאות ותשעים ואחת" },
            {"תשצ\"ב", "חמשת אלפים ושבע מאות ותשעים ושנים" },
            {"תשצ\"ג", "חמשת אלפים ושבע מאות ותשעים ושלשה" }
